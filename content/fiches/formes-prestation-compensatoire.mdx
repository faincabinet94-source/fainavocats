...
Le juge doit veiller à ce que ce laps de temps ne soit pas trop étendu, afin que la prestation compensatoire ne se transforme pas en [pension alimentaire déguisée](/pension-alimentaire).

## La prestation mixte

Il est également possible de combiner les deux formes : un **capital** accompagné d'une **rente**. Cette solution est parfois retenue lorsque le capital seul ne permet pas de compenser [la disparité créée par le divorce](/fiches/condition-attribution-prestation-compensatoire).

Le choix entre le capital et la rente n'est pas neutre : il commande le [traitement fiscal de la prestation](/fiches/prestation-compensatoire-fiscalite), tant pour celui qui verse que pour celui qui reçoit.
