...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    url: "https://fain-avocats.fr/droit-penal-famille",
    type: "website",
  },
};
...
const jsonLd = {
  ...
  "@type": "LegalService",
  name: "Fain Avocats - Avocat Droit Pénal de la Famille Paris",
  description: data.metaDescription,
  url: "https://fain-avocats.fr/droit-penal-famille",
  provider: {
    "@type": "Attorney",
  ...
  serviceType: "Droit Pénal de la Famille",
};

export default function DroitPenalFamillePage() {
  return (
    <>
      <Navbar />
