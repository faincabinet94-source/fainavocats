        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.facebook.com/fain.parras"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
              ...
              <a
                href="https://www.instagram.com/fain.avocats.famille/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@fain.avocat"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="text-gray-500 hover:text-[#010101] transition-colors"
              >
